...
do
CUDA_VISIBLE_DEVICES=7 "/mlainas/teang1995/anaconda3/envs/cluster/bin/python3" main.py --model=linear --optim=adam --lr_init=${lr_init} --wd=${wd} --epochs=200 --scheduler=constant 
done
done
